...
\item Если $I^k=J^k = \varnothing$, то $d^k=-f'(x^k)$. В противном
  ...
  \begin{equation}
    ...
    \begin{cases}
      ...
      d_{i+} \geq 0,\, d_{i-} \geq 0,\,d_{i+}\cdot d_{i-}=0,\, i\notin I^k
    \end{cases}
  \end{equation}
...
\item
  ...
  \item Определим коэффициенты $s_*, \hat{s}_1, \hat{s}_2, \bar{s}_1$.
    \begin{itemize}
    \item Минимум функции $f(x^1+s_*\cdot d^1) = (5-10s_*)^2+(6s_*-3)^2$
...
\item Продолжим поиск минимума из точки
  ...
  \item Определим коэффициенты $s_*, \hat{s}_1, \hat{s}_2, \bar{s}_1$.
    \begin{itemize}
    \item Минимум $f(x^2+s_*\cdot d^2) = 16+(s_*-\frac{32}{5})^2$
