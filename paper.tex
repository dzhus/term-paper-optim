...
\pgfplotsset{every axis plot post/.append style={black,solid,mark=none}}
\begin{figure}[hb]
  \centering
  \begin{tikzpicture}[scale=1]
    \begin{axis}[xlabel=$x$, ylabel=$y$,grid]
      \input{rosenbrock-contours.tkz.tex}
      \input{rosenbrock_relch_-1.2,1-trace.tkz.tex}
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[hb]
  ...
  \begin{tikzpicture}[scale=1]
    \begin{axis}[xlabel=$x$, ylabel=$y$,grid]
      ...
      \input{exptest_relch_2,1-trace.tkz.tex}
      \input{exptest_relch_5,5-trace.tkz.tex}
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[hb]
  ...
  \begin{tikzpicture}[scale=1]
    \begin{axis}[xlabel=$x$, ylabel=$y$,grid]
      ...
      \input{himmelblau_relch_0.1,0.1-trace.tkz.tex}
      \input{himmelblau_relch_0.5,-0.5-trace.tkz.tex}
      \input{himmelblau_relch_-0.5,0.5-trace.tkz.tex}
      \input{himmelblau_relch_-0.5,-0.5-trace.tkz.tex}
    \end{axis}      
  \end{tikzpicture}
