...
\item $\lambda_1 ≠ 0$ 
  ...
  \item $\lambda_2 = 0$
    ...
    \item $\lambda_3 = 0$
      ...
      \eqref{eq:cond-slackness-l1n=0}. Итак, получена ещё одна точка
      $B = \left(\frac{8}{5}, \frac{6}{5}\right)$. При этом из
      уравнения \eqref{eq:cond-stationary-l2=0} найдём значение
      $\lambda_1 = -\frac{28}{5}$.
    \item $\lambda_3 ≠ 0$
