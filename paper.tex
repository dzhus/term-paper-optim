...
Для решения задач условной оптимизации нелинейных функционалов
используется метод, построенный на основе \emph{необходимых} условий
Куна—Таккера (см. \cite{taha05}).
...
\end{multline}
Где $\lambda$ — вектор $\lambda_1, \lambda_2, \lambda_3$.
...
стационарности:
\begin{itemize}
\item $A = (0, 4),\, \lambda=(0, 8, 0)$
\item $B = (\frac{8}{5}, \frac{6}{5}),\, \lambda=(-\frac{28}{5}, 0, 0)$
\item $C = (1, 0),\, \lambda=(-5, 0, -3)$
\end{itemize}
