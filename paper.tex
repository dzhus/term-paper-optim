...
\makeatletter
\newcommand{\bthethm}{\arabic{section}.\arabic{thm}}

% Curried version of \newtheoremstyle
\newcommand{\mynewtheoremstyle}[2]{%
  \newtheoremstyle%
    {#1}% style name
    {0.15\baselineskip}% space above
    {0.15\baselineskip}% space below
    {#2}% body font
    {}% no indent
    {\scshape}% small caps for theorem head
    {.}% punctiation after head
    {0.3em}% space after head
  {\thmhead@plain{##1}{\bthethm}{##3}}}

\mynewtheoremstyle{ruthm}{\itshape}
\mynewtheoremstyle{rudfn}{}
\mynewtheoremstyle{rurem}{}
\makeatother
...
% Old style numerals for references to theorems
\renewcommand{\thethm}{\oldstylenums{\arabic{section}}.\oldstylenums{\arabic{thm}}}

\numberwithin{equation}{section}
\renewcommand{\theequation}{\oldstylenums{\arabic{section}}.\oldstylenums{\arabic{equation}}}
