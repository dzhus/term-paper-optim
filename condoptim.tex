...
Метод Зойтендейка относится к классу методов возможных направлений.

Итерационные методы возможных направлений реализуют решение задачи
...
условиям \eqref{eq:zoutendijk-problem-form}.
