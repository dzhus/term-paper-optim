\begin{figure}[!thb]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[thick,draw=black,mark=none]
      ...
      \draw node[circle, fill=black, scale=0.25, every pin edge/.style={draw=black, line width=2pt},
                 pin={right:\contour{white}{$(2, 3.5)$}}] at (axis cs:2,3.5) {};
      \draw node[circle, fill=black, scale=0.25, 
                 pin={left:$(0, 2)$}] at (axis cs:0,2) {};

      % Minimization process
      \addplot[line width=1.5pt, arrows=-triangle 45] coordinates{(0, 0) (0, 2)};
      \addplot[line width=1.5pt, arrows=-triangle 45] coordinates{(0, 2) (2,3.5)};
    \end{axis}
  \end{tikzpicture}
